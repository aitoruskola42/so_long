...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/06 12:47:25 by auskola-          #+#    #+#             */
/*   Updated: 2023/09/06 13:44:51 by auskola-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_memory_images(t_data *data)
{
	...
	data->enemy_pic = mlx_xpm_file_to_image(data->mlx_ptr, \
	"./textures/lobo.xpm", &data->res, &data->res);
	data->enemy2_pic = mlx_xpm_file_to_image(data->mlx_ptr, \
	"./textures/oveja.xpm", &data->res, &data->res);
