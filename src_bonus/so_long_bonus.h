...
/*   Updated: 2023/09/21 14:32:36 by auskola-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

//player_start_pos_x -> p_st_p_x
//p_st_p_y -> p_st_p_y
//player_screen_pos_x -> p_sc_p_x
//player_screen_pos_y -> p_sc_p_y
//patch_m -> used to send x, y, x2, y2 to function
//t_player	patch_m -> p_m
//next_pos_y -> n_p_y
//next_pos_x -> n_p_x
...
# define MLX_ERROR 1
# define GAME_TITLE "El gato volador" 
# define START_SPEED 60
# define ENEMY_KEY 'G'
# define WINDOW_WIDTH_CELLS 25
# define WINDOW_HEIGHT_CELLS 15
# define WAIT_RIGHT_CELLS 10
# define WAIT_DOWN_CELLS 10
...
void	check_argc(t_data *data, int number, char *argv[]);
//void	animate_array_images2(t_data *data, int x, int y);
int		check_enemy(t_data *data);
void	create_threads(t_data *data);
void	*move_enemy(void *enemy_data);
int		check_enemy_pos(t_data *data);
void	check_enemy_move(t_data *data, int i, int j);
int		change_enemy_position(t_data *data, int x, int y);
int		enemy_move_time(t_data *data, int i, int j, int m);
